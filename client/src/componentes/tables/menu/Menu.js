...
var {showMenu,
changeMenuIndex,
selectedAccount}=MainTableContext
  return (
    <Dialog
      header={"anfer"}
      visible={true}
...
<TabView activeIndex={tabNumber} onTabChange={(e) => changeMenuIndex(e.index)}>
    ...
    <TabPanel header="Gestion Judicial">
    ...
    <TabPanel header="Mas informacion">
